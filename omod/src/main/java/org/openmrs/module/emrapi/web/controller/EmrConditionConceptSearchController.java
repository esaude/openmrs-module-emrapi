...
@Controller
@RequestMapping(method = RequestMethod.GET, value = "/rest/emrapi/conditionconcept")
public class EmrConditionConceptSearchController {
    ...
    public Object search(@RequestParam("term") String query, @RequestParam Integer limit) throws Exception {
        Collection<Concept> diagnosisSets = emrApiProperties.getConditionisSets();
